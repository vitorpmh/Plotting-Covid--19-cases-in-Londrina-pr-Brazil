 ...
 !!! ESCREVE OS VALORES DA PRIMEIRA SIMULACAO
 
 DIA=0                                      !INICIALIZA A VARIAVEL DIA
 
 I=1
 
 WRITE(ARQUIVO,12) I                        !ESCREVE NOME DO ARQUIVO A SER ABERTO USANDO O NUMERO I
 12 FORMAT('ARQUIVOS/EVOL_TEMPORAL_',I0.2,'.dat')    !FORMATO DO NOME
 
 OPEN(2,FILE=ARQUIVO,STATUS='OLD')          !ABRE O ARQUIVO
    
 CICLO_DADOS1:DO J=1,15
 ...
 !!! ESCREVE OS VALORES DAS SIMULACOES INTERMEDIARIAS
 
 CICLO_ARQUIVOS:DO I=2,N-1
    ...
    CICLO_DADOS:DO J=1,15
    
        IF (J<=2) THEN                                      !PRIMEIRA E SEGUNDA LINHA DO ARQUIVO
 ...
 CICLO_DADOS2:DO J=1,LIN
    ...
    IF (J<=2) THEN                                      !PRIMEIRA LINHA DO ARQUIVO
