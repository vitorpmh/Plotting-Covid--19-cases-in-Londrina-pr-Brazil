...
set output "inf-atual-cort-linha-ingles.png"
...
plot 	"arquivo_geral_Londrina.dat-ingles.dat" using ($1):($4 - $7) with linespoints linestyle 1 title "Dataset: Londrina",\
	...
	"arquivo_geral_Londrina-datas-ingles.dat" using ($1):($4 - $7) every 13 with impulses lw 1.2 dashtype "-" lc "black" notitle,\
	"arquivo_geral_Londrina-datas-ingles.dat" using ($1):($2):($2) every 13::26::182  with labels font ",12" textcolor lt -1 rotate by 45 offset 3,2 notitle,\
	"arquivo_geral_Londrina-datas-ingles.dat" every ::0::0 using ($1):($4 - $7):($2) with labels font ",12" textcolor lt -1 rotate by 45 offset 3,2 notitle,\
	"arquivo_geral_Londrina-datas-ingles.dat" every ::13::13 using ($1):($4 - $7):($2) with labels font ",12" textcolor lt -1 rotate by 45 offset 3,1.7 notitle,\
